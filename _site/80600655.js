import{p as c}from"./6188f9dd.js";const s=()=>c`
  <footer>
...
</footer>`,t=document,o=[{key:"demo",story:s}];let e=!1;for(const c of o){const s=t.querySelector(`[mdjs-story-name="${c.key}"]`);s&&(s.story=c.story,s.key=c.key,e=!0,Object.assign(s,{}))}e&&(customElements.get("mdjs-preview")||import("./e0bbf46b.js"),customElements.get("mdjs-story")||import("./0603282e.js"));export{s as demo};
